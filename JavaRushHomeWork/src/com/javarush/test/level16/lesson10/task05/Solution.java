...
public class Solution {
    ...
    public static class Water implements Runnable {
        ...
        public void run() {
            ...
            Thread curentThread = Thread.currentThread();      //currentThread возвращает ссылку на
            boolean isCurrentThreadInterrupted = curentThread.isInterrupted();
            String threadName = curentThread.getName();
