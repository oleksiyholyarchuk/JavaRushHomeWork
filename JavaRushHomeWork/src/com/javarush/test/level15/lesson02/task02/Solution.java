...
public class Solution {
    ...
    public static class Goose extends SmallAnimal {
        ...
        {
            return "Гусь маленький, " + super.getSize();    //To change body of overridden methods use File | Settings | File Templates.
        }
    }
    ...
    public static class Dragon extends  BigAnimal {
        ...
        public String getSize()
        {
            return "Дракон большой, " + super.getSize();    //To change body of overridden methods use File | Settings | File Templates.
        }
    }
